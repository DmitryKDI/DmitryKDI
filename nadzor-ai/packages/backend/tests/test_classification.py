...
def test_filename_signal_matches_js():
    cases = {
        ...
        "V2_01-08-00-04-09_Том ООС8.4.pdf": "ООС",
        "V2_01-08-00-03-01.Том ООС8.3.pdf": "ООС",
    }
...
def test_section_number_requires_tom_to_reject_unrelated_numeric_markings():
    """Г.82 (независимый аудит Opus) — реальная находка: без привязки к
    ...
    номер акта) — синтетический пример из отчёта аудита реально давал
    ...
    cases = {
        ...
        "V2_01-08-00-01-04-02_Том 8.7.pdf": None,
