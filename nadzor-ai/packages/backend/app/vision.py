...
# Реальный сбой (эпоха локального провайдера, Ollama/qwen2.5vl:7b, с тех пор
# удалён — Г.71): на инженерном чертеже (номера помещений, оси — мелкий
...
# картинке. Поднято до 2200px. Не проверено повторно на текущих провайдерах
# (Anthropic/GigaChat) — статус эксперимента, не подтверждённого правила.
VISION_MAX_DIM = 2200
