...
Поля:
- shifr — шифр проекта целиком, как написан (например «XXX/000000/0-РД-АР»,
  «XXX/000000/0-РД-КЖ1»);
- sheet_no — число из графы «Лист» (не из «Листов» — это разные графы, в
  «Листов» стоит общее количество листов комплекта);
- sheet_name — наименование чертежа: «План 1 этажа», «Схема расположения
  элементов конструкций», «Принципиальная схема системы (начало)» и т.п.;
...
{"shifr": "…" или null, "sheet_no": <число> или null,
 "sheet_name": "…" или null, "discipline_code": "АР" или null}"""
