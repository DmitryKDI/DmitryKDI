...
зрение по чертежам, таблицы распределения) — каждый сканирует свой тип данных.
...
таблицы распределения) как считали свою часть один раз, так и продолжают —
...
реестр оборудования, граф маршрутизации инженерных систем, сверка
назначений по таблицам распределения ПД, прямое визуальное сравнение
чертежей)
